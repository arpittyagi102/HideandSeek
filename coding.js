        ...
        phlanum=phlanum+2;
        if(dusranum==1){
            document.getElementById("bg2").style.backgroundImage="url(\"tngbg2.png\")";
        }
        else if(dusranum==2){
            document.getElementById("bg2").style.backgroundImage="url(\"ringsbg.png\")";
        }
        else if(dusranum==3){
            document.getElementById("bg2").style.backgroundImage="url(\"piggybankbg.png\")";
        }
        ...
        for(let j=0;j<one.length;j++){
            for(let i=0;i<phlanum;i++){
                ...
                if(dusra==1){
                    ...
                    one[j].innerHTML +="<td> <img class=\"images\" style=\"border-radius:30px\" id=\""+number+"\" src=\"closed.png\" > </td>";
                } 
                else if(dusra==3){
                    one[j].innerHTML +="<td> <img class=\"images\" id=\""+number+"\" src=\"piggybank.png\" > </td>";
                }
        ...
        function giftfound(no){
            if(dusra==1){
                ...
                document.getElementById(no).src="open.png";
            }
            else if(dusra==3){
                document.getElementById(no).src="coins.png"
            }
        ...
        function giftmissed(no){
            ...
            if(dusra==1){
                ...
                document.getElementById(no).src="empty.png";
            }
            else if(dusra==3){
                document.getElementById(no).style.visibility="hidden";
            }
        ...
        function goback(){
            window.location.href="/hns/index.html";
        }
